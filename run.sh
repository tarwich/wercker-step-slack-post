...
WERCKER_SLACK_FALLBACK_MESSAGE="$WERCKER_APPLICATION_NAME: $WERCKER_SLACK_POST_ACT #${WERCKER_DEPLOY_ID:0:5} [$WERCKER_GIT_REPOSITORY/$WERCKER_GIT_BRANCH@${WERCKER_GIT_COMMIT:0:3}] by $WERCKER_STARTED_BY $WERCKER_RESULT."

export MESSAGE_TEXT="$WERCKER_SLACK_POST_ACT $WERCKER_SLACK_POST_WURL $WERCKER_RESULT in $WERCKER_TIME_SPENT"
