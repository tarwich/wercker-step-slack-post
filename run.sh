...
export WERCKER_SLACK_POST_MESSAGE="<$WERCKER_APPLICATION_URL|$WERCKER_APPLICATION_NAME> $WERCKER_SLACK_POST_ACT #$WERCKER_SLACK_POST_URL [$WERCKER_SLACK_POST_GIT] by $WERCKER_STARTED_BY $WERCKER_RESULT."
